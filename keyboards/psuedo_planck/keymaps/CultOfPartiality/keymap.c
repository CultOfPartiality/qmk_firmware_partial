...
[_RAISE] = LAYOUT_planck_grid(
    KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_PGUP, C(KC_LEFT), KC_UP,   C(KC_RGHT), KC_0,    _______,
    KC_DEL,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_PGDN, KC_LEFT,    KC_DOWN, KC_RGHT,    KC_RBRC, _______,
