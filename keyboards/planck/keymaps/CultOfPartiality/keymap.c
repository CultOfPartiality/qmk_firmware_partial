...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_LCTL, KC_LGUI, KC_LALT, NUMPAD, LOWER,   KC_SPC,  KC_ENT,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    KC_DEL,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,      KC_MINS, KC_LPRN, KC_RPRN, KC_LCBR, KC_RCBR, KC_PIPE,
    _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,     KC_EQL,  KC_LBRC, KC_RBRC, _______, _______, _______,
...
[_RAISE] = LAYOUT_planck_grid(
    KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_PGUP, C(KC_LEFT), KC_UP,   C(KC_RGHT), KC_0,    KC_BSPC,
    KC_DEL,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_PGDN, KC_LEFT,    KC_DOWN, KC_RGHT,    KC_RBRC, KC_BSLS,
    _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_HOME,    KC_NUBS, KC_END,     KC_PGDN, _______,
...
[_ADJUST] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, _______, _______, _______,          _______, C(G(KC_LEFT)), _______, C(G(KC_RGHT)), _______, _______,
