...
[_LOWER] = LAYOUT( \
  ...
  KC_GRV,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                          KC_EQL,  KC_LBRC, KC_RBRC, XXXXXXX, XXXXXXX, KC_F12,  \
  _______, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,                          KC_MINS, KC_LPRN, KC_RPRN, XXXXXXX, XXXXXXX, KC_PIPE, \
