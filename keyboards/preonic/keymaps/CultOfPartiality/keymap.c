...
[_QWERTY] = LAYOUT_preonic_grid(
  ...
  KC_LCTL, KC_LGUI, KC_LALT, LOWER,   LOWER,   KC_SPC,  KC_ENT,  RAISE,   RAISE,   KC_RALT, KC_RGUI, KC_RCTL
),
...
[_LOWER] = LAYOUT_preonic_grid(
  ...
  KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR,   KC_LPRN, KC_F11, KC_DEL,
  KC_DEL,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_UNDS, KC_PLUS,   KC_LCBR, KC_F12, KC_PIPE,
...
[_ADJUST] = LAYOUT_preonic_grid(
  ...
  MODTAP,  RESET,   DEBUG,   _______, _______, _______, _______, _______,       _______, _______,       _______, KC_DEL,
